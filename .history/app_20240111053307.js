...
// Calculate the maximum translate value based on the number of photos
const maxTranslate = -(totalImages - 1) * imageWidthPercentage;
...
function updateGalleryTransform() {
  ...
  // Disable right button if the translation reaches the maximum value
  rightButton.disabled = translateValue === maxTranslate;
